  ...
  childStateHandler(state){
	...
	render() {
		if (this.state.checkout === true) {
			...
			return <Signup childStateHandler={this.childStateHandler} signupHandler={this.signupHandler} />;
		} else if (this.state.payment === true) {
			return <Payment childStateHandler={this.childStateHandler} paymentHandler={this.paymentHandler} />;
		} else if (this.state.shipping === true) {
			return <Shipping shippingHandler={this.shippingHandler} childStateHandler={this.childStateHandler}/>;
